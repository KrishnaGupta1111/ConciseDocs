            ...
            >
              <div className="bg-rose-50 border border-rose-200 rounded-lg p-4 text-rose-800">
                <p className="text-sm ">
                  {(() => {
                    let planName = "";
                    if (uploadLimit === 2) planName = "Free plan";
                    else if (uploadLimit === 5) planName = "Basic plan";
                    else if (uploadLimit >= 1000) planName = "Pro plan";
                    return `You've reached the limit of ${uploadLimit} uploads on the ${planName}. `;
                  })()}
                  <Link
                    href={"/#pricing"}
